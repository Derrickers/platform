...
public class MenuDTO {
    ...
    public static ArrayList<MenuDTO> getAdminMenu(){
        ...
        children2.add(generateMenuDTO(303,"资产设备设施","goods",new ArrayList<>()));
        children2.add(generateMenuDTO(304,"配件类型","goods",new ArrayList<>()));
        children2.add(generateMenuDTO(305,"配件类型","params",new ArrayList<>()));
        children2.add(generateMenuDTO(306,"配件设施","classifications",new ArrayList<>()));
        children2.add(generateMenuDTO(307,"非资产类型","classifications",new ArrayList<>()));
